...
ENT.Base 		= "base_core3"
ENT.PrintName		= "Dova-Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Animation		= "core02_idle" -- Set's the animation of the core, a list can be found here: http://pastebin.com/SAHyMZ3k
ENT.Delay		= 5 -- Delay in seconds between each sound the core makes (excluding 'special' sounds)
ENT.Dir			= "dova" -- The name of your sub-folder, must be 4 characters.
ENT.MusicCore		= true
/*---------------------------------------------------------
